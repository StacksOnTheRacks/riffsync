...
- Covers **official Live channels**: hostless **`/live/:slug`** surfaces bound to **`catalog: live`** episodes via a seeded LiveChannel registry, member-chat / anonymous-view gates, and header **Live** nav — see **`domain_model.md`**, **US-P0-14*** / **US-P1-04a** in **`user_stories.md`**, and **`.ai/specs/official-live-channels.spec.md`**.
