...
- Covers **catalog browse IA**: hub mixed browse vs subcategory filtered views (MST3K host-era aggregation, Community, Riff-Ready label, Movie Night) without new auth or domain entities — see **`domain_model.md`** and **US-P0-01** in **`user_stories.md`**.
