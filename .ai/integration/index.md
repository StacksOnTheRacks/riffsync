...
Scopes **HTTP/WebSocket APIs**, **external providers** (YouTube, TMDB, Meta, AWS surfaces), **authorization modes**, **participant A/V over mediasoup SFU (all environments)**, **scheduled/async** integrations, and **realtime hardening** drawer boundaries (chat vs SFU decoupling, typed errors, conformance harness pointer).
