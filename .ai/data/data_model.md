...
| **Rooms playback denormalization (#392)?** | On create and episode-change **`PATCH`**, copy resolved **`playbackHost`**, **`customPlaybackUrl`**, and optional **`youtubeVideoId`** from Catalog onto the **Rooms** item; echo on room snapshot JSON. |
