...
- **Public catalog, home, and marketing surfaces** (**`/`**, **`/catalog`**, **`/catalog/mst3k`**, **`/catalog/community`**, **`/catalog/riff-material`**, **`/catalog/movie-night`**, **`/watch/:catalogEpisodeId`**, **`/how-to-host-a-watchparty`**, **`/terms`**, **`/privacy`**) are in scope for document-level head tags, heading semantics, image alt text, Catalog hub/dropdown navigation, and subcategory page shell (header + subtitle + grid) - see **`presentation.md`** -> *Public site head tags and heading semantics* / *Catalog hub and subcategory presentation*, **`interaction_flow.md`** -> *Catalog browse navigation*, and **`business_logic/domain_model.md`** -> *Public discoverable surface* for the indexable route boundary.
