...
describe('RoomHostIconRow', () => {
  ...
  it('uses gen-button on Share / Visibility / Rename like the top AV control bar', () => {
    ...
    const visibility = container.querySelector('button[aria-label="Live Now visibility"]')
  ...
  it('renders only Share for non-publishers', () => {
    ...
    expect(container.querySelector('button[aria-label="Live Now visibility"]')).toBeNull()
